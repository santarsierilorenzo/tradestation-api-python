from src.tradestation_python_client.base_client import BaseAPIClient
from src.tradestation_python_client.client import TradeStationClient
from unittest.mock import MagicMock, patch
import pytest


@patch("src.tradestation_python_client.client.MarketDataAPI")
...
@patch("src.tradestation_python_client.base_client.requests.get")
